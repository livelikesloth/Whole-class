...
<body>
	<div class="container">
		...
		<form action="signup.jsp" method="post" id="signupForm">
			...
			<div class="mb-3">
				<label class="control-label" for="email">직종 선택</label>
				<select class="form-select" aria-label="job">
			...
			<div class="mb-3">
				<label class="control-label" for="p-lang">주로 사용하는 언어</label>
				<input class="form-control" type="text" name="p-lang" id="p-lang" placeholder="programming language">
			</div>
			<div class="mb-3">
				<label class="control-label" for="p-lang">함께 살고 있는 동물</label>
				<input class="form-control" type="text" name="pet" id="pet" placeholder="함께 사는 동물을 입력하세요">
			</div>
